                ...
                {onGoogleSignIn && (
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2.5 py-2.5 px-4 rounded-xl border border-zinc-200 dark:border-white/[0.08] bg-zinc-50 hover:bg-zinc-100 dark:bg-zinc-900/80 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-200 text-xs font-semibold transition cursor-pointer shadow-xs"
                    >
                      <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24">
                        ...
                        <path
                          fill="#FBBC05"
                          d="M5.28 14.27A7.06 7.06 0 0 1 4.9 12c0-.79.14-1.57.38-2.27V6.58H1.25A11.97 11.97 0 0 0 0 12c0 1.92.45 3.74 1.25 5.42l4.03-3.15z"
                        />
                        <path
                          fill="#EA4335"
                    ...
                    <div className="relative flex items-center justify-center">
                      ...
                      <span className="bg-white dark:bg-zinc-900 px-3 text-[10px] uppercase font-semibold text-zinc-400 dark:text-zinc-500 absolute">
